...
function displayIcon( icon, iconSize=32 ) {
...
class gtIconPickerModal extends Component {
    constructor() {
        super( ...arguments );
...
export const IconPickerModal = compose( [
	withSelect( ( select ) => ( {
...
class gtIconPickerPlaceholder extends Component {
...
export const IconPickerPlaceholder = compose( [
