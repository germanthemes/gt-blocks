 ...
 */
registerBlockType(
	'gt-layout-blocks/grid-layout',
	{
		title: __( 'GT Grid Layout', 'gt-layout-blocks' ),

		description: __( 'Add a block that displays child blocks in a grid layout.', 'gt-layout-blocks' ),
		...
		keywords: [
			...
			__( 'Multiple', 'gt-layout-blocks' ),
			__( 'Columns', 'gt-layout-blocks' ),
		],
