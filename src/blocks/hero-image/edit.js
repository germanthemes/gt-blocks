...
class gtHeroImageEdit extends Component {
	...
	render() {
		...
		const blockId = `gt-hero-image-block-${ instanceId }`;
		...
		return (
			<Fragment>
				...
				<InspectorControls>
					...
					<PanelBody title={ __( 'Background Image' ) } initialOpen={ false } className="gt-blocks-hero-image-background-image-panel">
