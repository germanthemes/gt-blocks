...
const TEMPLATE = [
	[ 'core/quote', {
		placeholder: __( 'Write testimonial...', 'gt-blocks' ),
		synchronizeStyling: true,
		parentBlock: 'gt-blocks/testimonial-grid',
	} ],
];
 ...
 */
registerBlockType(
	'gt-blocks/testimonial-grid',
	{
		title: __( 'GT Testimonial Grid', 'gt-blocks' ),

		description: __( 'Displays your testimonials in a grid layout.', 'gt-blocks' ),
		...
		keywords: [
			__( 'Reviews', 'gt-blocks' ),
			__( 'Reference', 'gt-blocks' ),
			__( 'Grid', 'gt-blocks' ),
		],
