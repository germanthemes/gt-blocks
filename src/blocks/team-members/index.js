...
const ALLOWED_BLOCKS = [ 'gt-blocks/image', 'gt-blocks/heading', 'core/paragraph' ];

// Define blocks for each column.
const TEMPLATE = [
	[ 'gt-blocks/image', {
		synchronizeStyling: true,
		parentBlock: 'gt-blocks/team-members',
	} ],
	[ 'gt-blocks/content', {
		template: [
			[ 'gt-blocks/dual-heading', {
				synchronizeStyling: true,
				parentBlock: 'gt-blocks/team-members',
				titlePlaceholder: __( 'Name', 'gt-blocks' ),
				subtitlePlaceholder: __( 'Job Title', 'gt-blocks' ),
				titleTag: 'p',
				customFontSize: 20,
				subtitleCustomFontSize: 15,
			} ],
			[ 'core/paragraph', {
				placeholder: __( 'Write some words...', 'gt-blocks' ),
				synchronizeStyling: true,
				parentBlock: 'gt-blocks/team-members',
			} ],
		],
 ...
 */
registerBlockType(
	'gt-blocks/team-members',
	{
		title: __( 'GT Team Members', 'gt-blocks' ),

		description: __( 'Display your team members or employees in a grid layout.', 'gt-blocks' ),
