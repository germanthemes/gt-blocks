	...
	[ 'gt-layout-blocks/content', {
		template: [
			[ 'gt-layout-blocks/dual-heading', {
				synchronizeStyling: true,
				parentBlock: 'gt-layout-blocks/team-members',
				titlePlaceholder: __( 'Name' ),
				subtitlePlaceholder: __( 'Job Title' ),
				titleTag: 'p',
				customFontSize: 20,
...
registerBlockType(
	...
	{
		title: __( 'GT Team Members' ),

		description: __( 'Display your team members or employees in a grid layout.' ),
